...
<head>
    <meta charset="UTF-8">
    <title>Your Villa Has Been Created</title>
    <style>
        body { font-family: Arial, sans-serif; }
        .container { padding: 20px; max-width: 600px; margin: 0 auto; border: 1px solid #ddd; border-radius: 10px; }
        .header { background: #28a745; color: #fff; padding: 10px; text-align: center; border-radius: 10px 10px 0 0; }
...
<div class="container">
    <div class="header">
        <h2>Congratulations! Your Villa is Live</h2>
    </div>
    <div class="content">
        ...
        <p>Your villa has been successfully created and is now available for booking.</p>
    </div>
    <div class="footer">
