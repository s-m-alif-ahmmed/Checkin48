...
<header class="topbar">
    <div>
        ...
        <div class="topbar-title">{{ __('Villa Owner Dashboard') }}</div>
    </div>
    <div>
        ...
        <a href="{{ route('owner.add-villa') }}" class="button button-pri add-villa-btn">
            <span>{{ __('Add Villa') }}</span>
            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
                <path
                ...
                <path d="M6.66602 10H13.3327" stroke="white" stroke-width="1.5" stroke-linecap="round"
                    stroke-linejoin="round" />
                <path d="M10 13.3327V6.66602" stroke="white" stroke-width="1.5" stroke-linecap="round"
                    stroke-linejoin="round" />
            </svg>
        </a>
        {{-- <button id="notification-btn" type="button">
            ...
            >
                ...
                />
                <path
                    d="M16.0246 2.66602C11.1179 2.66602 7.14458 6.63935 7.14458 11.546V14.346C7.14458 15.2527 6.77124 16.6127 6.30458 17.386L4.61124 20.2127C3.57124 21.9593 4.29124 23.906 6.21124 24.546C12.5846 26.666 19.4779 26.666 25.8512 24.546C27.6512 23.946 28.4246 21.8393 27.4512 20.2127L25.7579 17.386C25.2912 16.6127 24.9179 15.2393 24.9179 14.346V11.546C24.9046 6.66602 20.9046 2.66602 16.0246 2.66602Z"
                    stroke="#1D2635"
                    stroke-width="2"
                    stroke-miterlimit="10"
                    stroke-linecap="round"
                />
                <path
                    d="M20.4425 25.0938C20.4425 27.5338 18.4425 29.5338 16.0025 29.5338C14.7892 29.5338 13.6692 29.0271 12.8692 28.2271C12.0692 27.4271 11.5625 26.3071 11.5625 25.0938"
                    stroke="#1D2635"
                    stroke-width="2"
                    stroke-miterlimit="10"
                />
                <circle cx="24" cy="6.66602" r="4" fill="#FF3F3F" />
            </svg>
        </button> --}}
...
{{--                    <div class="user-role">{{ Auth::user()->role == 'owner' ? __('Villa Owner') : '' }}</div>--}}
                </div>
            </button>
        </div>
    </div>
