...
@section('content')
    ...
    <div class="main-content">
        ...
        <main class="dashboard-content">
            <form action="{{ route('user.update.profile', $data->id) }}" class="profile-form" method="POST" enctype="multipart/form-data">
                @csrf
                @method('PATCH')
              ...
              <div class="dashboard-card address-form">
                <fieldset class="dashboard-input-wrapper full">
                  ...
                  <fieldset class="dashboard-input-wrapper">
                      ...
                      <select class="searchSelect" name="state_id" id="state_id">
                          @if($data->state_id)
                  ...
                  <fieldset class="dashboard-input-wrapper">
                      ...
                      <input type="number" id="zip_code" name="zip_code" value="{{ $data->zip_code }}" />
                      @error('zip_code')
                      <span class="text-danger">{{ $message }}</span>
                      @enderror
                  </fieldset>
        ...
        <div class="dashboard-content-password">
            <form action="{{ route('user.update.profile.password', $data->id) }}" class="profile-form" method="POST" enctype="multipart/form-data">
                @csrf
                @method('PUT')
