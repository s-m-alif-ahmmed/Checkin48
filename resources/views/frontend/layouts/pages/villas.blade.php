...
@section('content')
    ...
    @php
        ...
        $cmsNew = $cms->where('id', 3)->first(); // Use first() instead of get()
    ...
    <section class="hero-sec"
        style="background-image: url('{{ asset($banner_image ?? '/frontend/assets/images/exp-img-1.png') }}')">
        ...
        <div class="container">
            <div class="hero-content">
                <div class="banner-breadcrumb">
                    ...
                    <a href="{{ route('villas') }}" class="banner-breadcrumb-item">{{ __('Villas') }}</a>
                </div>
    ...
    <main>
        ...
        <section class="section container listing-section">
            <div class="listing-header">
                <div class="listing-title-box">
                    <h2 class="listing-title">{{ __('Villa listing') }}</h2>
                    ...
                    <div class="col-lg-3 col-xl-4">
                        <div class="listing-filters responsive-filter">
                            <div class="filter-search">
                                ...
                                <input type="text" class="search-keyword-input"
                                    placeholder="{{ __('Search keyword') }}" />
                            </div>


                            <div class="filter-location">
                                <input type="text" class="location-search-input"
                                    placeholder="{{ __('Location name') }}" />
                                <img src="{{ asset('/frontend/assets/images/icons/current-location.svg') }}"
                                    alt="location icon" />
                            </div>
                            ...
                            <div class="filter-range">
                                ...
                                <div class="range-wrapper">
                                    <input type="range" class="range-input min-range" min="100" max="10000"
                                        step="100" value="100" data-target="#minPrice" />
                                    <input type="range" class="range-input max-range" min="100" max="10000"
                        ...
                        @if ($villas->count() > 0)
                            <div class="listing-latest mt-3 mt-xl-5">
                                <div class="title">{{ __('Latest villas') }}</div>
                                <div class="listing-latest-items">
                                    {{-- latest villa start --}}
                                    @foreach ($villas->take(5) as $villa)
                                        <a href="{{ route('villas.details', ['slug' => $villa->slug]) }}"
                                            class="listing-latest-item">
                                            <figure class="listing-latest-item-img">
                                                <img src="{{ asset('/frontend/assets/images/exp-img-1.png') }}"
                                                    alt="Image" />
                                            </figure>
                                            <div class="listing-latest-item-content">
                                                <div class="listing-latest-item-title">
                                                    {{ $villa->title ?? '' }}
                                                </div>
                                                <div class="listing-latest-item-details">
                                                    @if ($villa->room)
                                                        <div class="listing-latest-details-item">
                                                ...
                                                <div class="listing-latest-item-price">
                            ...
                            <div>
                                <div class="testimonial-header">
                                    ...
                                    <div class="client-details">
                                        ...
                                        <div class="client-job">{{ __('Villa') }}: {{ $review->villa->title ?? '' }}
                                        </div>
                                    </div>
                                </div>
        ...
        @if ($our_latest_blogs->count() > 0)
            ...
            <section class="section container">
                ...
                <div class="blog-items">
                    @foreach ($our_latest_blogs as $item)
                        <div class="blog-item">
                            <figure class="blog-img">
                                <img src="{{ $item->image ? asset($item->image) : asset('frontend/assets/images/blog-1.png') }}"
                                    alt="Blog image"
...
@push('scripts')
    <script type="text/javascript">
        const checkIn = new easepick.create({
