...
@section('title', 'Owner Statement Create')
    ...
    <div class="row">
        <div class="col-lg-12 col-xl-12 col-md-12 col-sm-12">
            <div class="card box-shadow-0">
                <div class="card-body">
                    <form method="POST" action="{{ route('owner.statement.store') }}" >
                        @csrf
                        @method('POST')
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control @error('statement.en') is-invalid @enderror"
                                   name="statement[en]" placeholder="Owner Statement" id="statement_en" value="{{ old('statement.en') }}">
                            @error('statement.en')
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control @error('statement.ar') is-invalid @enderror"
                                   name="statement[ar]" placeholder="Owner Statement" dir="rtl" id="statement_ar" value="{{ old('statement.ar') }}">
                            @error('statement.ar')
                            <span class="text-danger">{{ $message }}</span>
                            @enderror
                        </div>
