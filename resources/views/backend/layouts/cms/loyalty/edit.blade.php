...
<div class="page-header">
    <div>
        <h1 class="page-title">Edit Loyalty Banner</h1>
    </div>
...
<div class="row">
    <div class="col-lg-12 col-xl-12 col-md-12 col-sm-12">
        <div class="card box-shadow-0">
            <div class="card-body">
                <form action="{{ route('cms.loyalty.update', $heros->id) }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                <label for="sub_title_en" class="form-label">Banner Sub Title(EN):</label>
                                <input type="text" class="form-control @error('sub_title.en') is-invalid @enderror"
                                       name="sub_title[en]" placeholder="Enter here banner sub title" id="sub_title_en"
                                       value="{{ old('sub_title.en', $heros->getTranslation('sub_title', 'en')) }}">
                                @error('sub_title.en')
                                <span class="text-danger">{{ $message }}</span>
                                @enderror
                            </div>
                            <div class="form-group">
                                <label for="sub_title_ar" class="form-label">Banner Sub Title(AR):</label>
                                <input type="text" class="form-control @error('sub_title.ar') is-invalid @enderror"
                                       name="sub_title[ar]" dir="rtl" placeholder="Enter here banner sub title" id="sub_title_ar"
                                       value="{{ old('sub_title.ar', $heros->getTranslation('sub_title', 'ar')) }}">
                                @error('sub_title.ar')
                                <span class="text-danger">{{ $message }}</span>
                                @enderror
                            </div>
