...
<div class="page-header">
    <div>
        <h1 class="page-title">Edit Home Banner</h1>
    </div>
    ...
    <div class="col-lg-12 col-xl-12 col-md-12 col-sm-12">
        <div class="card box-shadow-0">
            <div class="card-body">
                ...
                <form action="{{ route('cms.home.header.update', $heros->id) }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                <label for="banner_image" class="form-label">Banner Image(Big Screen):</label>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                <label for="banner_image_mobile" class="form-label">Banner Image(Mobile Screen):</label>
                                <input type="file" class="dropify @error('banner_image_mobile') is-invalid @enderror" name="banner_image_mobile" id="banner_image_mobile" data-default-file="{{ isset($heros->banner_image_mobile) ? asset($heros->banner_image_mobile) : '' }}">
