...
<div class="page-header">
    <div>
        <h1 class="page-title">Edit Banner Form</h1>
    </div>
...
<div class="row">
    <div class="col-lg-12 col-xl-12 col-md-12 col-sm-12">
        <div class="card box-shadow-0">
            <div class="card-body">
                <form action="{{ route('cms.aboutus.header.update', $heros->id) }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <input type="file" class="dropify @error('banner_image') is-invalid @enderror" name="banner_image"
                                       id="banner_image" data-default-file="{{ isset($heros->banner_image) ? asset($heros->banner_image) : '' }}">
                                @error('banner_image')
                                <span class="text-danger">{{ $message }}</span>
                                @enderror
                            </div>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <input type="file" class="dropify @error('page_image') is-invalid @enderror" name="page_image"
                                       id="page_image" data-default-file="{{ isset($heros->page_image) ? asset($heros->page_image) : '' }}">
                                @error('page_image')
                                <span class="text-danger">{{ $message }}</span>
                                @enderror
                            </div>
