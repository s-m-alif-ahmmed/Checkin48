...
<div class="page-header">
     <div>
        <h1 class="page-title">Edit Blog Detail Banner</h1>
    </div>
    <div class="ms-auto pageheader-btn">
        <ol class="breadcrumb">
            <li class="breadcrumb-item"><a href="javascript:void(0);">Dashboard</a></li>
            <li class="breadcrumb-item"><a href="javascript:void(0);">Blog Detail</a></li>
...
<div class="row">
    <div class="col-lg-12 col-xl-12 col-md-12 col-sm-12">
        <div class="card box-shadow-0">
            <div class="card-body">
                <form action="{{ route('cms.blog-detail.update', $heros->id) }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
