    ...
    <div class="page-header">
        ...
        <div class="ms-auto pageheader-btn">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="javascript:void(0);">News Letter</a></li>
        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-header border-bottom"
                    ...
                    <a href="{{ route('news.letter.create') }}" class="btn btn-primary">Add News Letter</a>
                </div>
...
@push('scripts')
    <script>
        ...
        function statusChange(id) {
            let url = '{{ route('news.letter.status', ':id') }}';
            $.ajax({
                type: "GET",
        ...
        function deleteItem(id) {
            let url = '{{ route('news.letter.destroy', ':id') }}';
