            ...
            <div class="card box-shadow-0">
                <div class="card-body">
                    <form method="post" action="{{ route('credentials.update') }}" enctype="multipart/form-data">
                        ...
                        <input type="hidden" name="facebook_client_id" value="{{ env('FACEBOOK_CLIENT_ID') }}">
                        <input type="hidden" name="facebook_client_secret_id" value="{{ env('FACEBOOK_CLIENT_SECRET') }}">
