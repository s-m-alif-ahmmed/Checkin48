                    ...
                    <form method="post" action="{{ route('settings.dynamic_page.update', ['id' => $data->id]) }}"
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control @error('page_title.en') is-invalid @enderror"
                                   name="page_title[en]" placeholder="title" id="title_en" value="{{ old('page_title.en', $data->getTranslation('page_title', 'en')) }}">
                            @error('page_title.en')
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control @error('page_title.ar') is-invalid @enderror"
                                   name="page_title[ar]" dir="rtl" placeholder="title" id="title_ar" value="{{ old('page_title.ar', $data->getTranslation('page_title', 'ar')) }}">
                            @error('page_title.ar')
                            <span class="text-danger">{{ $message }}</span>
                            @enderror
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control @error('page_content.en') is-invalid @enderror" id="summernote_en" name="page_content[en]">{{ old('page_content.en', $data->getTranslation('page_content', 'en')) }}</textarea>
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control @error('page_content.ar') is-invalid @enderror" dir="rtl" id="summernote_ar" name="page_content[ar]">{{ old('page_content.ar', $data->getTranslation('page_content', 'ar')) }}</textarea>
