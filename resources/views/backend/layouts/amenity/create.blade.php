...
@section('content')
    ...
    <div class="page-header">
        <div>
            <h1 class="page-title">Amenity Form</h1>
        </div>
                ...
                <div class="card-body">
                    <form action="{{ route('amenities.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="name[en]" id="name_en" class="form-control" value="{{ old('name.en') }}" placeholder="Enter amenity name" required>
                            @error('name.en')
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="name[ar]" id="name_ar" class="form-control" dir="rtl" value="{{ old('name.ar') }}" placeholder="Enter amenity name" required>
                            @error('name.ar')
                            <span class="text-danger">{{ $message }}</span>
                            @enderror
                        </div>
