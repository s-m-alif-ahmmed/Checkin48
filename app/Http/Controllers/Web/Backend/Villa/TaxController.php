...
class TaxController extends Controller
{
    ...
    {
        return view('backend.layouts.tax.create');
    }
    ...
    public function store(Request $request)
    {
        try {
            ...
            return redirect()->route('taxes.index')->with('t-success', 'Tax created successfully!');
        } catch (\Exception $e) {
            return redirect()->route('taxes.index')->with('t-error', 'Tax create failed!');
        }
    }
    ...
    public function destroy(int $id): JsonResponse {
        try {
            ...
            return response()->json([
                'success' => false,
                'message' => 'Failed to delete the Tax.',
            ]);
        }
    }
