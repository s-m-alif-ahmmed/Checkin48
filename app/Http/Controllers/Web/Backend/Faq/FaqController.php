    ...
    public function store(Request $request): RedirectResponse
    {
        try {
            $validator = Validator::make($request->all(), [
                ...
                'question.en'       => 'required|required_with:question.ar|string',
                'question.ar'       => 'required|required_with:question.en|string',

                'answer'            => 'required|array',
                'answer.en'         => 'required|required_with:answer.ar|string',
                'answer.ar'         => 'required|required_with:answer.en|string',
            ]);
    ...
    public function update(Request $request, int $id): RedirectResponse
    {
        try {
            $validator = Validator::make($request->all(), [
                ...
                'question.en'          => 'nullable|required_with:question.ar|string',
                'question.ar'          => 'nullable|required_with:question.en|string',

                'answer'            => 'nullable|array',
                'answer.en'            => 'nullable|required_with:answer.ar|string',
                'answer.ar'            => 'nullable|required_with:answer.en|string',
            ]);
